...
(function(Chart) {
	...
	var ValueGaugeScale = Chart.Element.extend({
		
		mergeTicksOptions: helpers.noop,
    ...
    Chart.scaleService.registerScaleType('valueGauge', ValueGaugeScale, defaultConfig);
}).call(this, Chart);
...
(function(Chart) {
	...
	Chart.controllers.linearGauge = Chart.controllers.bar.extend({
		/*
